...
from controller_client.paths.queue_dpid.get import QueueDpidGet
from controller_client.paths.queue_dpid_port.get import QueueDpidPortGet
from controller_client.paths.queue_dpid_port_queue_id.get import QueueDpidPortQueueIdGet


class QueueManagementApi(
    QueueDpidGet,
    QueueDpidPortGet,
    QueueDpidPortQueueIdGet,
):
