...
from dsmf_client.paths.slice_reservation.delete import SliceReservationDelete
from dsmf_client.paths.slice_reservation.get import SliceReservationGet
from dsmf_client.paths.slice_reservation.put import SliceReservationPut


class SliceReservationApi(
