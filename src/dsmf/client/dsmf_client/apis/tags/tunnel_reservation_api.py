...
from dsmf_client.paths.tunnel_reservation.delete import TunnelReservationDelete
from dsmf_client.paths.tunnel_reservation.get import TunnelReservationGet
from dsmf_client.paths.tunnel_reservation.put import TunnelReservationPut
