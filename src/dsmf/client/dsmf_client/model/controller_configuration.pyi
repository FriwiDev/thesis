...
class ControllerConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip", "port", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip", "port", "name", ], str]):
