...
class DomainConfiguration(
    ...
    def __getitem__(self,
                    name: typing_extensions.Literal["network_borders"]) -> MetaOapg.properties.network_borders: ...
    ...
    def __getitem__(self, name: typing_extensions.Literal[
        "reservable_bitrate"]) -> MetaOapg.properties.reservable_bitrate: ...

    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...

    def __getitem__(self, name: typing.Union[typing_extensions.Literal[
        "type", "network", "controllers", "vpn_gateways", "switches", "network_borders", "networks", "reservable_bitrate",], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vpn_gateways"]) -> typing.Union[
        MetaOapg.properties.vpn_gateways, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["switches"]) -> typing.Union[
        MetaOapg.properties.switches, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["network_borders"]) -> typing.Union[
        MetaOapg.properties.network_borders, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["networks"]) -> typing.Union[
        MetaOapg.properties.networks, schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reservable_bitrate"]) -> typing.Union[
        MetaOapg.properties.reservable_bitrate, schemas.Unset]: ...
    ...
    def __new__(
            ...
            *_args: typing.Union[dict, frozendict.frozendict,],
            ...
            network_borders: typing.Union[
                MetaOapg.properties.network_borders, list, tuple, schemas.Unset] = schemas.unset,
            networks: typing.Union[MetaOapg.properties.networks, list, tuple, schemas.Unset] = schemas.unset,
            reservable_bitrate: typing.Union[
                MetaOapg.properties.reservable_bitrate, decimal.Decimal, int, schemas.Unset] = schemas.unset,
            _configuration: typing.Optional[schemas.Configuration] = None,
            **kwargs: typing.Union[
