...
class NetworkBorderConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["network_name", "device_name", "device_type", "connection", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["network_name", "device_name", "device_type", "connection", ], str]):
