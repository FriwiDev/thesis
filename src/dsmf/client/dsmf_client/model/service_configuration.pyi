...
class ServiceConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "network", "controllers", "vpn_gateways", "switches", "network_borders", "reservable_bitrate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "network", "controllers", "vpn_gateways", "switches", "network_borders", "reservable_bitrate", ], str]):
