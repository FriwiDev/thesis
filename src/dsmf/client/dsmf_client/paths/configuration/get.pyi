...
SchemaFor200ResponseBodyApplicationJson = ServiceConfiguration
...
class ConfigurationGet(BaseApi):
    ...
    def configuration_get(
        ...
        return self._configuration_get_oapg(
