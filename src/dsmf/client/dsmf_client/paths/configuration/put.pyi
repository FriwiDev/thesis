...
# body param
SchemaForRequestBodyApplicationJson = ServiceConfiguration


request_body_service_configuration = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _configuration_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_service_configuration.serialize(body, content_type)
...
class ConfigurationPut(BaseApi):
    ...
    def configuration_put(
        ...
        return self._configuration_put_oapg(
            body=body,
