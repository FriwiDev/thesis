...
# body param
SchemaForRequestBodyApplicationJson = DomainConfiguration


request_body_domain_configuration = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _configuration_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_domain_configuration.serialize(body, content_type)
