...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'slice': typing.Union[SliceSchema, ],
    }
)
...
request_query_slice = api_client.QueryParameter(
    name="slice",
    style=api_client.ParameterStyle.FORM,
    schema=SliceSchema,
    required=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _slice_reservation_put_oapg(
        self,
...
class SliceReservationPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def slice_reservation_put(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def slice_reservation_put(
        ...
        return self._slice_reservation_put_oapg(
