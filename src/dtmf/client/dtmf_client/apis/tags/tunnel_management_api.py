...
from dtmf_client.paths.tunnel_deployment.delete import TunnelDeploymentDelete
from dtmf_client.paths.tunnel_deployment.get import TunnelDeploymentGet
from dtmf_client.paths.tunnel_deployment.put import TunnelDeploymentPut
