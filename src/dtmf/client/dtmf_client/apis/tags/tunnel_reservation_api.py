...
from dtmf_client.paths.tunnel_reservation.delete import TunnelReservationDelete
from dtmf_client.paths.tunnel_reservation.get import TunnelReservationGet
from dtmf_client.paths.tunnel_reservation.put import TunnelReservationPut


class TunnelReservationApi(
