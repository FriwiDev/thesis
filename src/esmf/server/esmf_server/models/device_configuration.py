...
from esmf_server.models.connection_configuration import ConnectionConfiguration
...
class DeviceConfiguration(Model):
    ...
    def __init__(self, ip: str='localhost', port: int=8082, connections: List[ConnectionConfiguration]=None, network: str=None, name: str=None):
