...
A simple API to manage QoS queues on arbitrary OpenFlow switches. Does not support listing queues (GET) because this is
already part of OpenFlow.
 ...
 *QueueManagementApi* | [**queue_delete**](docs/apis/tags/QueueManagementApi.md#queue_delete) | **delete** /queue |
 *QueueManagementApi* | [**queue_put**](docs/apis/tags/QueueManagementApi.md#queue_put)       | **put** /queue    |
...
If the OpenAPI document is large, imports in switch_client.apis and switch_client.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:

- `from switch_client.apis.default_api import DefaultApi`
...
import switch_client
from switch_client.apis import *
from switch_client.models import *
```
