...
import urllib3
from switch_client import rest
from switch_client.configuration import Configuration
from switch_client.exceptions import ApiTypeError, ApiValueError
from switch_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class Api:
    ...
    @staticmethod
    def _verify_typed_dict_inputs_oapg(cls: typing.Type[typing_extensions.TypedDict],
