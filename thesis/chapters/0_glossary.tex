...
\newglossaryentry{microsegmentation}
{
    name=micro-segmentation,
    description={The practice of partitioning a network into many small isolated islands in order to isolate tenants according to their needs}
}
