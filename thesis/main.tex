...
\begin{figure}[ht]
  ...
  \caption{ESMF to CTMF communication illustrated in a sequence diagram TODO: Update}
\end{figure}
\begin{figure}[ht]
  \centering
  \includesvg[inkscapelatex=false, width=\linewidth]{images/slice_creation_esmf_to_dsmf_to_switch.svg}
  \caption{ESMF to DSMF to switch communication illustrated in a sequence diagram TODO: Update and merge}
\end{figure}
\begin{figure}[ht]
  \centering
  \includesvg[inkscapelatex=false, width=\linewidth]{images/slice_creation_esmf_to_dsmf_to_vpn_gateway.svg}
  \caption{ESMF to DSMF to VPN gateway communication illustrated in a sequence diagram TODO: Update and merge}
\end{figure}
\begin{figure}[ht]
  \centering
  \includesvg[inkscapelatex=false, width=\linewidth]{images/slice_creation_ctmf_to_dtmf.svg}
  \caption{CTMF to DTMF communication illustrated in a sequence diagram TODO: Update}
\end{figure}
